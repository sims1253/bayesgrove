...
Workflow packs raise obligations as the analysis develops. Both can block
execution.
...
See the [getting-started tutorial](getting-started.html) for a complete review
and `?bayesgrove-concepts` for the console reference.
