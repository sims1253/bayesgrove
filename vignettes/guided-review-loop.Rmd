...
It intentionally exercises only the narrow `bayesgrove.default_bayesian` pack.
If you want process guidance, taxonomy review, predictive checks, SBC review,
stacking-aware model selection, Stan-specific review, or DAG-constrained
causal selection, add the richer packs described in
