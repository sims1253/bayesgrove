...
- `bayesgrove.pad_scaffold`: an advisory PAD annotation scaffold once a branch
  has an inferential goal.

The scope matters. `bayesgrove.model_selection` only acts at project scope
when there are at least two clean fit candidates. The causal and PAD packs are
branch-scoped prompts, not full domain systems, and they do not fire until the
branch has the right goal context.
