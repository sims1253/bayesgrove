...
Register your own node kinds and executors. bayesgrove handles the
graph, cache, decision log, and workflow protocol.
...
| Plugin | A built-in executor set (e.g. [`bg_use_cmdstanr()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_use_cmdstanr.md)) |
...
Registering new workflow-pack providers from an external package is not
a public API. For custom review logic, use one of these approaches:
