...
vignette builds without CmdStan on CI. The dataset and three Stan
programs ship with the package.
...
(posterior median and 90 percent interval of `exp(b_treatment)`):
...
times wider. The failed predictive check raised a blocking obligation,
and the decision log records why the Poisson model was rejected.
