...
#> Report exported to
#> /tmp/RtmpgzAa0x/bg-simulation-study/simulation-study-report.md
report_path
#> [1] "/tmp/RtmpgzAa0x/bg-simulation-study/simulation-study-report.md"
```

The report includes graph topology, decision provenance, gate context,
evidence nodes, and the artifact index for the current run.
