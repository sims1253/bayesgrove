...
- [`bayesgrove-concepts`](https://sims1253.github.io/bayesgrove/dev/reference/bayesgrove-concepts.md)
...
- [`bg_handle()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_handle.md)
...
- [`bg_open()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_open.md)
  : Open a bayesgrove Project
- [`bg_close()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_close.md)
  : Close a bayesgrove Project

## Graph Construction

- [`bg_add_node()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_add_node.md)
  : Add a node to the bayesgrove project graph
- [`bg_connect()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_connect.md)
...
- [`bg_remove_node()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_remove_node.md)
...
- [`bg_read_graph()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_read_graph.md)
  : Read project graph
- [`bg_commit_graph()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_commit_graph.md)
...
- [`bg_plan()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_plan.md)
...
- [`bg_compact_jobs()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_compact_jobs.md)
  : Compact the append-only jobs log
- [`bg_compute_fingerprint()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_compute_fingerprint.md)
  : Compute the cache fingerprint for a node
- [`bg_status()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_status.md)
  : Get workflow status
- [`bg_result()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_result.md)
  : Retrieve a result artifact from the workflow
- [`bg_pause()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_pause.md)
  : Pause the workflow execution
- [`bg_resume()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_resume.md)
  : Resume the workflow execution
- [`bg_snapshot()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_snapshot.md)
  : Retrieve a complete snapshot of the project state
- [`bg_bundle()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_bundle.md)
...
- [`bg_fit_brms()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_fit_brms.md)
  : Fit a brms model in one call

## Visualization

- [`bg_graph_mermaid()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_graph_mermaid.md)
...
- [`bg_list_templates()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_list_templates.md)
...
- [`bg_workflow_packs()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_workflow_packs.md)
...
- [`bg_execute_action()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_execute_action.md)
  : Execute a workflow action from the protocol surface
- [`bg_extension_registry()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_extension_registry.md)
  : Return the descriptive extension registry for a project
- [`bg_partition_protocol_by_scope()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_partition_protocol_by_scope.md)
  : Partition protocol results by scope
- [`bg_build_workflow_context()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_build_workflow_context.md)
  : Build the workflow context for a given scope

## Workflow State

- [`bg_read_branch_registry()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_read_branch_registry.md)
  : Read the persisted branch registry
- [`bg_read_goal_registry()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_read_goal_registry.md)
  : Read the persisted goal registry
- [`bg_list_branches()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_list_branches.md)
  : List all branches with their metadata
- [`bg_branch_lineage()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_branch_lineage.md)
  : Get the ancestor branch lineage for a branch
- [`bg_scope_label()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_scope_label.md)
  : Get a display label for a scope
- [`bg_set_goal()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_set_goal.md)
  : Set the active inferential goal for a branch
- [`bg_get_goal()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_get_goal.md)
  : Get the active inferential goal for a scope
- [`bg_read_summaries()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_read_summaries.md)
  : Read persisted summaries
- [`bg_write_summaries()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_write_summaries.md)
  : Persist executor summaries
- [`bg_summary_vocabulary()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_summary_vocabulary.md)
  : Built-in summary-kind vocabulary
- [`bg_register_summary_kind()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_register_summary_kind.md)
...
- [`bg_retire_node()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_retire_node.md)
  : Retire a node and downstream lineage
- [`bg_retire_branch()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_retire_branch.md)
  : Retire an entire branch
- [`bg_invalidate()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_invalidate.md)
...
- [`bg_answer_gate()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_answer_gate.md)
  : Answer a decision gate
- [`bg_pending_gates()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_pending_gates.md)
...
- [`bg_read_decisions()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_read_decisions.md)
...
- [`bg_use_brms()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_use_brms.md)
  : Register brms node kinds on a project.
- [`bg_hmc_severity()`](https://sims1253.github.io/bayesgrove/dev/reference/bg_hmc_severity.md)
