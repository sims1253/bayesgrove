...
Contributor note: graph-generic `dagriculture` boundary helpers now live in `R/22-dagri-adapters.R`, while workflow semantics such as policy holds, branch scope, summaries, and decision provenance remain in BayesGrove.
