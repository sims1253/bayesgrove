...
The demo shows the full guided loop: a fit with divergent transitions triggers a blocking obligation, you branch and modify to use non-centered parametrization, rerun, and the workflow advances.
